...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.bd90c5a9.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.9dad4370.mjs'));
...
//# sourceMappingURL=error-component.ff4b4abd.mjs.map
