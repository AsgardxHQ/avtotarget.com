...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.0f542ba8.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.ea15098b.mjs'));
...
//# sourceMappingURL=error-component.eefea181.mjs.map
