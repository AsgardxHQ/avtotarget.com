...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.83bcc947.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.15126787.mjs'));
...
//# sourceMappingURL=error-component.6236813a.mjs.map
