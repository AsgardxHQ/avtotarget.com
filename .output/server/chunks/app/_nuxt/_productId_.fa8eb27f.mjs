  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (renderItem.value && Object.keys(renderItem.value).length > 0) {
        _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><div class="w-full flex mt-8"><div class="w-2/5 px-5"><div><img${serverRenderer.exports.ssrRenderAttr("src", `/images/products/${renderItem.value.images[0]}` || "/images/no_image.png")}></div></div><div class="w-3/5 px-5 divide-y divide-slate-200"><h1 class="text-slate-600 pb-3">${serverRenderer.exports.ssrInterpolate(renderItem.value[`name_${vue_cjs_prod.unref(route).params.locale}`])}</h1><div class="py-3"><ul class="text-xs"><li class="mb-2"><span class="font-bold">${serverRenderer.exports.ssrInterpolate(_ctx.$t("items.code_vendor"))}: </span>${serverRenderer.exports.ssrInterpolate(renderItem.value.code_vendor)}</li>`);
...
//# sourceMappingURL=_productId_.fa8eb27f.mjs.map
