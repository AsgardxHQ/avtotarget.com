...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.35d89b44.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.dcad2af1.mjs'));
...
//# sourceMappingURL=error-component.0bca0bd0.mjs.map
