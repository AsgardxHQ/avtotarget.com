import { v as vue_cjs_prod, f as useAsyncData, S as Slider, g as _sfc_main$9, h as _sfc_main$8 } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$9, { class: "main-page" }, null, _parent));
...
//# sourceMappingURL=index.fc670c1f.mjs.map
