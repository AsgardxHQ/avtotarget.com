  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (currentItems.value && currentItems.value.length > 0) {
        ...
        _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$8, { items: currentItems.value }, null, _parent));
        _push(`</div>`);
        _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$a, { pagination: pagination.value }, null, _parent));
        _push(`<!--]-->`);
      } else {
        _push(`<!---->`);
      }
...
const Slider = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$1]]);
const meta$6 = void 0;
const meta$5 = void 0;
const meta$4 = void 0;
const meta$3 = void 0;
...
const routes = [
  {
    ...
    meta: meta$9,
    alias: [],
    component: () => import('./_nuxt/page-_page_.7cd9e6c8.mjs').then((m) => m.default || m)
  },
  {
    ...
    meta: meta$8,
    alias: [],
    component: () => import('./_nuxt/page-_page_.11669beb.mjs').then((m) => m.default || m)
  },
  {
    name: "locale-cart",
    path: "/:locale/cart",
    ...
    meta: meta$7,
    alias: [],
    component: () => import('./_nuxt/cart.9e4c92db.mjs').then((m) => m.default || m)
  },
  {
    name: "locale",
    path: "/:locale",
    ...
    meta: meta$6,
    alias: [],
    component: () => import('./_nuxt/index.fc670c1f.mjs').then((m) => m.default || m)
  },
  {
    ...
    meta: meta$5,
    alias: [],
    component: () => import('./_nuxt/about_us.3b16c4f9.mjs').then((m) => m.default || m)
  },
  {
    ...
    meta: meta$4,
    alias: [],
    component: () => import('./_nuxt/contacts.ebd270aa.mjs').then((m) => m.default || m)
  },
  {
    ...
    meta: meta$3,
    alias: [],
    component: () => import('./_nuxt/delivery.21f6235c.mjs').then((m) => m.default || m)
  },
  {
    ...
    meta: meta$2,
    alias: [],
    component: () => import('./_nuxt/_productId_.b3613994.mjs').then((m) => m.default || m)
  },
  {
    ...
    meta: meta$1,
    alias: [],
    component: () => import('./_nuxt/_request_.9c2c9586.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    meta,
    alias: [],
    component: () => import('./_nuxt/index.e3f93441.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  "admin-only": () => import('./_nuxt/admin-only.a4b4133c.mjs'),
  "guest-only": () => import('./_nuxt/guest-only.df680d6c.mjs'),
  redirect: () => import('./_nuxt/redirect.56e10c5c.mjs'),
  "user-only": () => import('./_nuxt/user-only.5ccdab47.mjs')
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue_cjs_prod.withDirectives((vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("button", {
    ...
    vue_cjs_prod.renderSlot(_ctx.$slots, "default", {}, () => [
      ...
      vue_cjs_prod.createElementVNode("span", _hoisted_2, vue_cjs_prod.toDisplayString($props.label || "\xA0"), 1),
...
const _sfc_main$5 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./_nuxt/error-component.6236813a.mjs'));
    const nuxtApp = useNuxtApp();
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_client_only, null, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(serverRenderer.exports.ssrRenderComponent(_sfc_main$4, null, null, _parent2, _scopeId));
          } else {
            return [
              vue_cjs_prod.createVNode(_sfc_main$4)
            ];
          }
        }),
        _: 1
...
export { Slider as S, _sfc_main$7 as _, useRouter as a, useAuthUser as b, cartStore as c, __nuxt_component_0 as d, entry$1 as default, __nuxt_component_0$1 as e, useAsyncData as f, _sfc_main$9 as g, _sfc_main$8 as h, _export_sfc as i, useNuxtApp as j, defineNuxtRouteMiddleware as k, abortNavigation as l, useHead as m, navigateTo as n, useRoute as u, vue_cjs_prod as v };
