import { getCurrentInstance, version, inject, ref, onServerPrefetch, unref, computed, reactive, defineComponent, createElementBlock, useSSRContext, watchEffect, watch, h, resolveComponent, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, createApp, markRaw, effectScope, isRef, isReactive, toRaw, provide, onErrorCaptured, getCurrentScope, onScopeDispose, nextTick, toRef, shallowRef, isReadonly, defineAsyncComponent, toRefs, resolveDirective, withDirectives, openBlock, normalizeClass, renderSlot, createCommentVNode, createElementVNode, Suspense, Transition } from 'vue';
...
import { createError as createError$1, sendRedirect, setResponseStatus as setResponseStatus$1 } from 'h3';
import { hasProtocol, parseURL, parseQuery, withTrailingSlash, withoutTrailingSlash, joinURL, isEqual } from 'ufo';
import { ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderComponent, ssrRenderSuspense } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-_page_-21f7a364.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-_page_-dcd66952.mjs').then((m) => m.default || m)
  },
  {
    name: "locale-cart",
    path: "/:locale/cart",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/cart-a366a24c.mjs').then((m) => m.default || m)
  },
  {
    name: "locale",
    path: "/:locale",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0a936b0d.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about_us-8c93bb6d.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contacts-3e091ab7.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/delivery-0c3b3205.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_productId_-34249da8.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_request_-f5bf461b.mjs').then((m) => m.default || m)
  }
];
...
const _imports_0 = "" + __publicAssetsURL("images/logo-6.png");
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed top-0 left-0 w-full h-full bg-slate-800/50 flex items-center justify-center" }, _attrs))}><div class="rounded w-96 p-8 bg-white shadow-2xl"><div class="relative pt-6 flex"><a class="absolute -right-2 -top-2 text-gray-400 hover:text-gray-700" href=""><i class="pi pi-times"></i></a><div class="${ssrRenderClass([unref(typeAuth) === 0 ? "bg-gray-200" : "", "w-1/2 text-center rounded-t py-2 cursor-pointer hover:bg-gray-200"])}"><h3 class="uppercase">${ssrInterpolate(_ctx.$t("sign_in"))}</h3></div><div class="${ssrRenderClass([unref(typeAuth) === 1 ? "bg-gray-200" : "", "w-1/2 text-center rounded-t py-2 cursor-pointer hover:bg-gray-200"])}"><h3 class="uppercase">${ssrInterpolate(_ctx.$t("reg_in"))}</h3></div></div>`);
      if (unref(typeAuth) === 0) {
        _push(`<!--[--><div class="border-y py-4"><div class="py-2 flex items-center"><input class="w-full form-input px-4 py-3 rounded outline-0 border" type="email" placeholder="Email"${ssrRenderAttr("value", unref(form).email)}> ${ssrInterpolate(unref(error).email)}</div><div class="py-2 flex items-center"><input class="w-full form-input px-4 py-3 rounded outline-0 border" type="password" placeholder="Пароль"${ssrRenderAttr("value", unref(form).password)}> ${ssrInterpolate(unref(error).password)}</div></div><div class="pt-4 flex justify-end"><button class="bg-green-700 hover:bg-green-900 mt-2 py-3 px-6 rounded text-white uppercase text-xs font-bold">${ssrInterpolate(_ctx.$t("come_in"))}</button></div><!--]-->`);
      } else {
        _push(`<!--[--><div class="border-y py-4"><div class="py-2 flex items-center"><input class="w-full form-input px-4 py-3 rounded outline-0 border" type="email" placeholder="Email"${ssrRenderAttr("value", unref(form).email)}> ${ssrInterpolate(unref(error).email)}</div><div class="py-2 flex items-center"><input class="w-full form-input px-4 py-3 rounded outline-0 border" type="password" placeholder="Пароль"${ssrRenderAttr("value", unref(form).password)}> ${ssrInterpolate(unref(error).password)}</div><div class="py-2 flex items-center"><input class="w-full form-input px-4 py-3 rounded outline-0 border" type="password" placeholder="Подтвердить пароль"${ssrRenderAttr("value", unref(form).password_confirm)}> ${ssrInterpolate(unref(error).password_confirm)}</div></div><div class="pt-4 flex justify-end"><button class="bg-green-700 hover:bg-green-900 mt-2 py-3 px-6 rounded text-white uppercase text-xs font-bold">${ssrInterpolate(_ctx.$t("come_in"))}</button></div><!--]-->`);
      }
      _push(`</div></div>`);
    };
  }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("mainPage"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("mainPage")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("pages.about_us"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("pages.about_us")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("pages.delivery"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("pages.delivery")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("pages.contacts"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("pages.contacts")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} class="w-full"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<form class="md:w-2/4 sm:w-2/3 px-5"><div class="flex w-full shadow-md"><input type="text" name="search"${ssrRenderAttr("value", unref(searchText))} class="w-full form-input px-4 py-3 rounded-l-md outline-0"${ssrRenderAttr("placeholder", _ctx.$t("search_pl"))}><button type="submit" class="w-20 px-4 py-3 bg-slate-600 text-gray-100 rounded-r-md outline-0 transition-all hover:bg-slate-400">${ssrInterpolate(_ctx.$t("search_btn"))}</button></div></form><div class="w-1/4 flex justify-end">`);
      _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
      _push(`</div></div></div>`);
      if (unref(showModal)) {
        _push(ssrRenderComponent(_sfc_main$5, { openSignIn }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-slate-500 mt-8" }, _attrs))}><div class="w-full py-4 flex item-center justify-center text-xs text-slate-100">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`</div><div class="w-full flex justify-center text-lg pb-4">© ${ssrInterpolate(unref(year))} autotarget.com. ALL RIGHTS RESERVED.</div></footer>`);
    };
  }
});
...
const getAllData = defineStore({
  ...
  actions: {
    ...
    async getCategories() {
      const { data } = await useFetch("/api/v1/categories", "$xbL5jIdYpO");
      return data.value;
    }
  }
});
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_NuxtLoadingBar = resolveComponent("NuxtLoadingBar");
  ...
  _push(ssrRenderComponent(_component_NuxtLoadingBar, { duration: 3e3 }, null, _parent));
  _push(ssrRenderComponent(_component_NuxtPage, { class: "m-auto md:w-full md:px-4 md:w-full xl:max-w-5xl" }, null, _parent));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-faa6b96b.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-5a7ace1a.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { __nuxt_component_0$2 as _, useFetch as a, useRouter as b, createError as c, cartStore as d, entry$1 as default, __nuxt_component_0 as e, _export_sfc as f, useAsyncData as g, useNuxtApp as h, useHead as i, useRoute as u };
